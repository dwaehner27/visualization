var myMap = L.map("map2", {
  ...
  function chooseOpac(X) {
    return ((X.properties.Price-37)/200)
  }
  ...
  layer.bindPopup("<h1>" + feature.properties.neighborhood + "</h1> <hr> <h2>"+"<dt>Avg. Price</dt>" + "$" + feature.properties.Price + "</h1> <hr> <h2>" + "<dt>Total Rentals</dt>" +feature.properties.Number + "</h2>");
