var myMap = L.map("map", {
  ...
  onEachFeature: function(feature, layer) {
    ...
    layer.bindPopup("<h1>" + feature.properties.neighborhood + "</h1> <hr> <h2>" +"<dt>Price</dt>" + feature.properties.Price + "</h1> <hr> <h2>" + "<dt>Total Rentals</dt>" +feature.properties.Number + "</h2>");
